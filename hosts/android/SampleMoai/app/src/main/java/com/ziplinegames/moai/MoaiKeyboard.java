...
public class MoaiKeyboard {
	...
	public static void onCreate ( Activity activity ) {
		...
		mKeyInTextView.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
		...
		mKeyInTextView.addTextChangedListener ( new TextWatcher () {
			...
			public void afterTextChanged ( Editable s ) {
				...
				mKeyInTextView.removeTextChangedListener(this);

				mKeyInTextView.setText("");

				mKeyInTextView.addTextChangedListener(this);
			}
		...
		mKeyInTextView.setOnKeyListener ( new OnKeyListener () {
	...
	public static void hideKeyboard () {	
		// Handler handler = new Handler ( sActivity.getBaseContext().getMainLooper () );
