...
import com.getmoai.sample.samplemoai.R;
...
public class MoaiActivity extends Activity {
	public interface CloseSpashCallback { public void onClose(); }

	public static CloseSpashCallback		splashCloseCallback;
	...
	protected void onCreate ( Bundle savedInstanceState ) {
		...
		Moai.initNativeLib ( "fmod", this );
		Moai.initNativeLib ( "moai", this );
		Moai.initNativeLib ( "game", this );

		MoaiLog.i ( "MoaiActivity onCreate: activity CREATED" );

		splashCloseCallback = new CloseSpashCallback () { 

			public void onClose() {

				MoaiActivity.this.runOnUiThread( new Runnable () {
		...
		if ( getCacheDirectory ( this ) != null ) {
			 
		 	Moai.setCacheDirectory ( getCacheDirectory ( this ).getAbsolutePath () );
		} else {
		...
		if (version >= 13) {
	    	...
	    	mMoaiView = new MoaiView ( this, displayMetrics.widthPixels, displayMetrics.heightPixels, info.reqGlEsVersion );
		...
		RelativeLayout.LayoutParams splashParams = new RelativeLayout.LayoutParams ( LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT );
		...
		mImmersiveModeHandler.setupView ( mMoaiView );
	}
	...
	protected void onPause () {
		...
		MoaiLog.i ( "MoaiActivity onPause: ------------------------------------------------- SESSION END ------------------------------------------- " );
		Moai.endSession ();		
	}
	...
	protected void onResume () {
		...
		mImmersiveModeHandler.enableImmersiveMode ();
	}
	...
	protected void onSaveInstanceState ( Bundle outState ) {
		...
		Moai.onSaveInstanceState ( outState );
	}
	...
	public boolean onKeyUp ( int keyCode, KeyEvent event ) {
		...
		MoaiLog.i ("MoaiActivity onKeyUp, keycode " + keyCode + " event: " + event );
		...
		mImmersiveModeHandler.handleKeyDown(keyCode, event);
