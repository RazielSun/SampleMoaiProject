...
LOCAL_STATIC_LIBRARIES := $(MOAI_STATIC_LIBRARIES) moai-android moai-http-client moai-luaext moai-crypto moai-sim moai-util moai-core moai-fmod-studio moai-spine zlcore luaext luasql luacrypto luacurl luasocket luafilesystem liblua-static zlcrypto zlvfs contrib expat freetype png zlib jpg jansson sqlite3 tinyxml tlsf curl ssl crypto cares sfmt tess fmod spine
...
LOCAL_SRC_FILES += ParticlePresets.cpp
